...
| 🔒 **No telemetry** | Nothing leaves your machine except your dictation audio (to the provider you picked), the optional GitHub update check, and — only if you opt in — Connections settings sync (preferences only, never keys/audio). |
