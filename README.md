...
| 🪄 **Little touches that add up** | A custom vocabulary so your jargon is heard right the first time, a fix-list for words it mishears, per-app profiles, a searchable dictation history that survives restarts and updates, a *"scratch that"* voice command, and your music muted or turned down while you talk (it comes back the moment you stop). |
