...
- **About box with update check** - A native About window shows the current version, license, and a status pill that checks for and can trigger an update install. - `src/about/mod.rs:154`, `src/about/updates.rs:19`, `src/about/updates.rs:102`
...
<!-- odin:about GENERATED END sha=69fed14762c2 -->
